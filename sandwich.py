...
def main():
    ...
    # Meat
    legham = Circle(Point(85, 320), 11)
    legham.setFill("lightpink")
    legham.draw(win)
    leghamtext = place_label_text(Point(85, 345), "Leg Ham", size=10)
    schnitzel = Oval(Point(145, 309), Point(185, 335))
    schnitzel.setFill("chocolate3")
    schnitzel.draw(win)
    schnitzeltext = place_label_text(Point(165, 345), "Schnitzel", size=10)
    salami = Circle(Point(85, 375), 11)
    salami.setFill("firebrick1")
    salami.draw(win)
    salamitext = place_label_text(Point(83, 400), "Salami", size=10)
    turkey = Oval(Point(145, 360), Point(185, 385))
    turkey.setFill("cornsilk")
    turkey.draw(win)
    turkeytext = place_label_text(Point(165, 400), "Turkey", size=10)
    ...
    # This ðŸ‘‡ can be replaced by just this â˜
    ...
    if 800 < clickPoint.getX() < 870 and 100 < clickPoint.getY() < 150:
